...
export interface NftInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "setMaxPerMint",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface Nft extends BaseContract {
  ...
  mintNFTs: TypedContractMethod<[_count: BigNumberish], [void], "payable">;
  ...
  setMaxPerMint: TypedContractMethod<
    [_maxPerMint: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "setMaxPerMint"
  ): TypedContractMethod<[_maxPerMint: BigNumberish], [void], "nonpayable">;
  getFunction(
